...
var __vue_render__ = function __vue_render__() {
  var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('span', { staticClass: "tag", class: (_obj = {}, _obj["tag-" + _vm.theme] = !_vm.hollow, _obj["tag-outline-" + _vm.theme] = _vm.hollow, _obj["tag-" + _vm.size] = _vm.size, _obj["border-" + _vm.shape] = _vm.shape, _obj), on: { "click": function click($event) {
        _vm.$emit('click');
      } } }, [_vm._t("default")], 2);
  var _obj;
};
